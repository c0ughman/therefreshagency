      ...
      <section className="value-props">
        <div className="value-props-container">
          ...
          <div className={`value-props-grid ${showValuePropsText ? 'text-fade-in' : ''}`}>
            ...
            >
              <h3>Diseño Digno de Premios</h3>
              <p>
              No más <b>sitios web aburridos y antiguos.</b><br />No más plantillas genéricas.<br />Expresamos tu marca de una manera única, poderosa y cautivadora.
              </p>
            </div>
            <div 
            ...
            >
              <h3>Máquina de Leads</h3>
              <p>
              Deja de perseguir clientes.<br /><i>Atraélos en su lugar.</i><br />
          Transformamos tu sitio web en una máquina generadora de clientes.
      ...
      <section id="reviews" className="reviews-section">
        <div className="reviews-container">
          <div className="reviews-header">
            ...
            <p>Resultados reales de negocios reales</p>
          </div>
        </div>
      </section>
          ...
          <div className="complex-container">
            <TiltEffect intensity={8} perspective={1200} className="complex-left" ref={webDesignRef}>
              <div className="bento-content">
                <h3>Diseño de Sitio Web Personalizado</h3>
                <p>Desarrollo completo de extremo a extremo con hosting, mantenimiento y optimización. Construimos todo desde cero.</p>
              ...
              <div className="complex-bottom-right">
                <div className="complex-left-of-8">
                  ...
                  <TiltEffect intensity={30} perspective={900} className="complex-square-5">
                    <div className="bento-content">
                      <h3>Integración Completa de Chatbot IA al Sitio Web</h3>
                      <div className="bento-features">
...
✓ Sitio web impresionante y de alto rendimiento<br />
      ...
      <section id="projects" className="projects-section">
        <div className="projects-container">
          <div className="projects-header">
            ...
            <p>Mostrando nuestro trabajo más reciente y soluciones creativas</p>
          </div>
          {/* Project 1 - Briefed */}
      ...
      <section id="mission" className="mission-section">
        <div className="mission-container">
          ...
          <div className="mission-content">
            ...
            <p className="mission-subtitle">Redefinir el panorama digital infundiendo sitios con belleza, impacto, expresión y diseño intuitivo.</p>
            <div className="mission-text">
              <p>
<strong>Elevar la Estética y Expresión</strong> Creando plataformas digitales impresionantes e intuitivamente diseñadas que reflejen la esencia única de cada marca, haciendo de internet un lugar más intencional e impactante.<br /><br />

<strong>Maximizar el Potencial No Aprovechado</strong> Desbloqueando el potencial completo de herramientas y estrategias novedosas, transformando sitios web en poderosos motores para ganancias multiplicadas, rendimiento mejorado y resultados tangibles.<br /><br />

<strong>Eliminar el Esfuerzo Innecesario</strong> Creando sistemas con propósito que impulsen las ganancias de la manera más eficiente y escalable. No más trabajo anticuado, innecesario o de bajo impacto.
</p>
            </div>
        ...
        <div className="footer-content">
          <div className="footer-grid">
            ...
            <div className="footer-section">
              <h4><span className="dash">----</span>Servicios<span className="dash">---</span></h4>
              <ul>
                <li><a href="#bento" data-service="web-design">Diseño Web</a></li>
                <li><a href="#bento" data-service="marketing">Marketing y Embudos</a></li>
                <li><a href="#bento" data-service="chatbot">Chatbot IA</a></li>
                <li><a href="#bento" data-service="mvp">Desarrollo MVP</a></li>
              </ul>
            </div>
            
            <div className="footer-section">
              <h4><span className="dash">----</span>Proyectos<span className="dash">---</span></h4>
              <ul>
            ...
            <div className="footer-section">
              <h4><span className="dash">----</span>Empresa<span className="dash">---</span></h4>
              <ul>
                <li><a href="#projects">Portafolio</a></li>
                <li><a href="#reviews">Reseñas</a></li>
                <li><a href="#bento">Productos</a></li>
                <li><a href="#mission">Misión</a></li>
                <li><a href="/es/contact">Hablemos</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="footer-ibm-logo">
            ...
            <a href="/es/contact" className="footer-cta-button">Hablemos</a>
          </div>
        </div>
      </footer>
