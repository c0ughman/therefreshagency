  ...
  return (
    <div className="contact-page">
      ...
      <main className="contact-main">
        ...
        {/* CTA Button */}
        <a href="https://wa.me/19784045049?text=Hola%20%F0%9F%91%8B%F0%9F%8F%BB%20Quiero%20una%20web%20excepcional%20que%20me%20traiga%20clientes.%20%C2%BFQu%C3%A9%20sigue?" target="_blank" rel="noopener noreferrer">
          ...
          <div className={styles.contactFooterCtaFunnel}>
            ...
            <div className={styles.contactFooterCtaFunnelBasePriceNote}>
              <span className={styles.contactFooterCtaFunnelBasePriceText}>
                Este es el precio base. Para proyectos que incluyan ecommerce, blog completo, traduccion, páginas funnel extra, etc. <a href="https://wa.me/19784045049?text=Hola%20%F0%9F%91%8B%F0%9F%8F%BB%20Quiero%20una%20web%20excepcional%20que%20me%20traiga%20clientes...%20%C2%BFQu%C3%A9%20sigue?" target="_blank" rel="noopener noreferrer" style={{textDecoration: 'underline', fontWeight: 'bold', fontStyle: 'normal', color: 'black'}}>Contáctanos para una cotización personalizada.</a>
              </span>
            </div>
          </div>
        </div>
