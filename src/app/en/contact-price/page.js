  ...
  return (
    <div className="contact-page">
      ...
      <main className="contact-main">
        ...
        {/* CTA Button */}
        <a href="https://wa.me/19784045049?text=Hi%20%F0%9F%91%8B%F0%9F%8F%BB%20I%20want%20an%20exceptional%20website%20that%20brings%20me%20clients.%20What's%20next?" target="_blank" rel="noopener noreferrer">
          ...
          <div className={styles.contactFooterCtaFunnel}>
            ...
            <div className={styles.contactFooterCtaFunnelBasePriceNote}>
              <span className={styles.contactFooterCtaFunnelBasePriceText}>
                This is the base price. For projects that include ecommerce, complete blog, translation, extra funnel pages, etc. <a href="https://wa.me/19784045049?text=Hi%20%F0%9F%91%8B%F0%9F%8F%BB%20I%20want%20an%20exceptional%20website%20that%20brings%20me%20clients...%20What's%20next?" target="_blank" rel="noopener noreferrer" style={{textDecoration: 'underline', fontWeight: 'bold', fontStyle: 'normal', color: 'black'}}>Contact us for a personalized quote.</a>
              </span>
            </div>
          </div>
        </div>
