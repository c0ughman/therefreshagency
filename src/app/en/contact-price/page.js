          ...
          <div className={styles.contactFooterCtaFunnel}>
            ...
            <div className={styles.contactFooterCtaFunnelBasePriceNote}>
              <span className={styles.contactFooterCtaFunnelBasePriceText}>
                This is the base price. For projects that include ecommerce, complete blog, translation, extra funnel pages, etc. <a href="https://wa.me/19784045049?text=Hi 👋🏻 I want an exceptional website that brings me clients... What's next?" target="_blank" rel="noopener noreferrer" style={{textDecoration: 'underline', fontWeight: 'bold', fontStyle: 'normal', color: 'black'}}>Contact us for a personalized quote.</a>
              </span>
            </div>
          </div>
        </div>
